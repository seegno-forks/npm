...
var findRequirement = exports.findRequirement = safe.recurseLimitSync(100, 1000, function (tree, name, requested, $$recurse$$) {
  ...
  return $$recurse$$(tree.parent, name, requested)
})
